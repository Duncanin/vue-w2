<template>
  <div class="max-w-6xl mx-auto py-4">
    <div class="grid grid-cols-3">
      <productList :products="products" @add-cart="addCart" class="col-span-3 md:col-span-2"/>
      <cart class="col-span-3 md:col-span-1 w-full"
      :carts="carts" @remove-cart="removeCart"/>
    </div>
...
<script setup>
import productList from '@/components/productView.vue';
import notify from '@/components/notifyView.vue';
...
const removeCart = (i)=> {
  carts.value = carts.value.filter(c=>c.id !== i.id)
}
